...
def get_batch(data_iterator):
    ...
    mask = (torch.rand((args.micro_batch_size, args.seq_length), requires_grad=False, device=torch.cuda.current_device())<0.5).float()

    return tokens, None, None, loss_mask, labels, mask
