...
class FlaxPositionWiseMoELayer(nn.Module):
    ...
    def __call__(self, inputs):
        ...
        combined_weights, dispatch_mask = top2_gating_dummy(gates)
        ...
        #dot.17->d_combined_weights
        outputs = jnp.einsum("GSEC,GECM->GSM", combined_weights, expert_outputs) #dot.11->d_expert_outputs
