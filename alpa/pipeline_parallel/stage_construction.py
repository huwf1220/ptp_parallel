...
def seperate_layers_as_segment(
    ...
    # treat every layer seperated by pp marker as a stage
    ...
    stage_to_segment = list(range(num_layers)) + list(reversed(range(num_layers)))
    ...
    return stages, stage_to_segment
...
def cluster_layers_and_slice_mesh(
    ...
    for stage_id, layer_ids in enumerate(stage_layer_ids):
        #HUWF1004: remove pp markers for every stage.
        # if len(layer_ids) == 1:
