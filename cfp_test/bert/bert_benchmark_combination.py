...
class AutoShardingAttentionTest(unittest.TestCase):
    ...
    def test_bert_layer_1d_mesh_pb(self):
...
def bert_pb_analysis_profiling_passes(config,
                                      batch_size,
                                      num_layer,
                                      device_num,
                                      data_type,
    ...
    bert_test.setUp(config, batch_size, num_layer, device_num, data_type,
                    debug_dir)
    bert_test.get_enum_bench_config()
    bert_test.test_bert_layer_1d_mesh_pb()
...
if __name__ == "__main__":
    ...
    bert_pb_analysis_profiling_passes(args.config, args.batch_size,
