...
class AutoShardingMoETest(unittest.TestCase):
    ...
    def test_moe_layer_1d_mesh_pb(self, mode):
...
def moe_pb_analysis_profiling_passes(mode,
                                     config,
                                     batch_size,
                                     num_layers,
                                     device_num,
    ...
    moe_test.setUp(config_str=config,
                   ...
                   data_type=data_type,
                   debug_dir=debug_dir)
    moe_test.test_moe_layer_1d_mesh_pb(mode)
...
if __name__ == "__main__":
    ...
    moe_pb_analysis_profiling_passes(args.mode, args.config, args.batch_size,
