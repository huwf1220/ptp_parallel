...
class AutoShardingAttentionTest(unittest.TestCase):
    ...
    def test_gpt_layer_1d_mesh_pb(self):
...
def gpt_pb_analysis_profiling_passes(config,
                                     batch_size,
                                     num_layer,
                                     device_num,
                                     data_type,
    ...
    gpt_test.setUp(config, batch_size, num_layer, device_num, data_type,
                   debug_dir)
    gpt_test.get_enum_bench_config()
    gpt_test.test_gpt_layer_1d_mesh_pb()
...
if __name__ == "__main__":
    ...
    gpt_pb_analysis_profiling_passes(args.config, args.batch_size,
