...
StatusOr<bool> AutoSharding::Run(
  ...
  // std::cerr << "*************force_batch_dim is: " << solver_option.force_batch_dim_to_mesh_dim << std::endl;
  //   std::cerr << "batch_matmul_always_split_batch is : " << solver_option.batch_matmul_always_split_batch<<std::endl;
  ...
  auto cost_graph_build_overhead = std::chrono::duration_cast<std::chrono::milliseconds>(std::chrono::steady_clock::now() - cost_graph_build_start);
  // std::cerr << "cost graph build time: " << cost_graph_build_overhead.count() << "ms.";

  // std::cerr << " =========================================================" << std::endl;
  // std::cerr << "Build cost graph: "<< std::endl;
  // std::cerr << " =========================================================" << std::endl;
  // std::cerr << cost_graph.ToString();

  cost_graph.Simplify();

  // std::cerr << " =========================================================" << std::endl;
  // std::cerr << "Simplified cost graph: "<< std::endl;
  // std::cerr << " =========================================================" << std::endl;
  // std::cerr << cost_graph.ToString();
  ...
  auto search_overhead = std::chrono::duration_cast<std::chrono::milliseconds>(std::chrono::steady_clock::now() - search_start);
  // std::cerr << "search time:" << search_overhead.count() << "ms.";
  // std::cerr << " =========================================================" << std::endl;
  // std::cerr << "Searched strategy." << std::endl;
  // std::cerr << " =========================================================" << std::endl;
