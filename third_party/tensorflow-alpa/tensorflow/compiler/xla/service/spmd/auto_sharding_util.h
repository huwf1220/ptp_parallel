...
// Return whether this instruction lies in some communication free path.
//bool InCommFreeRegions(const HloInstruction* inst, const CommunicationFreeRegions& regions);
